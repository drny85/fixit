...
>;
const ContractorMessadeDetails: FC<Props> = ({ route }) => {
	...
	const viewRef = useRef<React.MutableRefObject<FlatList>>();
			...
			>
				<FlatList
					...
					onContentSizeChange={(w, h) => {
						viewRef.current?.current.scrollToEnd({ animated: true });
					}}
					keyboardShouldPersistTaps='handled'
...
export default ContractorMessadeDetails;
